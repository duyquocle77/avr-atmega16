...
; 0000 0038 {
_main:
; 0000 0039 unsigned int adc_value;
; 0000 003A char *buffer_string;
; 0000 003B unsigned int adc_value2;
; 0000 003C char *buffer_string2;
...
; 0000 0098 ADMUX=ADC_VREF_TYPE & 0xff;
	LDI  R30,LOW(64)
	OUT  0x7,R30
; 0000 0099 ADCSRA=0xA3;
	LDI  R30,LOW(163)
	OUT  0x6,R30
...
; 0000 00A7 // RS - PORTD Bit 0
; 0000 00A8 // RD - PORTD Bit 1
; 0000 00A9 // EN - PORTD Bit 2
; 0000 00AA // D4 - PORTD Bit 4
; 0000 00AB // D5 - PORTD Bit 5
; 0000 00AC // D6 - PORTD Bit 6
; 0000 00AD // D7 - PORTD Bit 7
...
; 0000 00B3       adc_value = read_adc(0);
	...
	RCALL _read_adc
	MOVW R16,R30
; 0000 00B4       itoa(adc_value, buffer_string);
	ST   -Y,R17
	ST   -Y,R16
	ST   -Y,R19
	ST   -Y,R18
...
; 0000 00B5       lcd_gotoxy(0,0);
	...
	ST   -Y,R30
	CALL _lcd_gotoxy
; 0000 00B6       lcd_puts(buffer_string);
	ST   -Y,R19
	ST   -Y,R18
	CALL _lcd_puts
; 0000 00B7 
; 0000 00B8       adc_value2 = read_adc(1);
	LDI  R30,LOW(1)
	ST   -Y,R30
	RCALL _read_adc
	MOVW R20,R30
; 0000 00B9       itoa(adc_value2, buffer_string2);
	ST   -Y,R21
	ST   -Y,R20
	LDD  R30,Y+2
	LDD  R31,Y+2+1
...
; 0000 00BA       lcd_gotoxy(0,1);
	...
	ST   -Y,R30
	CALL _lcd_gotoxy
; 0000 00BB       lcd_puts(buffer_string2);
	LD   R30,Y
	LDD  R31,Y+1
	ST   -Y,R31
	ST   -Y,R30
