...
; 0000 008C // D4 - PORTD Bit 3
; 0000 008D // D5 - PORTD Bit 4
; 0000 008E // D6 - PORTD Bit 5
; 0000 008F // D7 - PORTD Bit 6
...
; 0000 0095       lcd_clear();
	RCALL _lcd_clear
; 0000 0096       lcd_gotoxy(3,1);
	LDI  R30,LOW(3)
	ST   -Y,R30
	LDI  R30,LOW(1)
	ST   -Y,R30
	RCALL _lcd_gotoxy
; 0000 0097       lcd_puts("Starting....");
	__POINTW1MN _0x6,0
	ST   -Y,R31
	ST   -Y,R30
	RCALL _lcd_puts
